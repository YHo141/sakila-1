			...
			<div id="outer">
				<div id="main">
					...
					<div id="content">
						...
						<div id="paging">	
							<a href="${path}/auth/starringActorServlet?currentPage=${1}&searchTitle=${searchTitle}&selectOption=${selectOption}">1</a>
							<a>...</a>
							<c:choose>
									...
									<c:forEach var="i" begin="${1}" end="${lastPage}">
										<c:choose>
											<c:when test="${i eq currentPage}">
												<a class="currentPage" href="${path}/auth/starringActorServlet?currentPage=${i}&searchTitle=${searchTitle}&selectOption=${selectOption}">${i}</a>	
											</c:when>
											<c:otherwise>
												<a href="${path}/auth/starringActorServlet?currentPage=${i}&searchTitle=${searchTitle}&selectOption=${selectOption}">${i}</a>	
											</c:otherwise>
										</c:choose>
									</c:forEach>
								</c:when>
							...
							<a>...</a>
							<a href="${path}/auth/starringActorServlet?currentPage=${lastPage}&searchTitle=${searchTitle}&selectOption=${selectOption}">end</a>		
						</div>
						<br class="clear" />
					</div>
					<br class="clear" />
