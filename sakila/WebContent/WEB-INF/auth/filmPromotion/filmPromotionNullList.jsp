				...
				<div id="main">
					...
					<div id="content">
							...
							<div id="contentSearch">
								<form method="post" action="${path}/auth/promotionNullServlet">
							...
							<div id="paging">	
								<a href="${path}/auth/promotionNullServlet?currentPage=${1}&searchTitle=${searchTitle}">1</a>
								<a>...</a>
								<c:choose>
										...
										<c:forEach var="i" begin="${1}" end="${lastPage}">
											<c:choose>
												<c:when test="${i eq currentPage}">
													<a class="currentPage" href="${path}/auth/promotionNullServlet?currentPage=${i}&searchTitle=${searchTitle}">${i}</a>	
												</c:when>
												<c:otherwise>
													<a href="${path}/auth/promotionNullServlet?currentPage=${i}&searchTitle=${searchTitle}">${i}</a>	
												</c:otherwise>
											</c:choose>
										</c:forEach>
									</c:when>
								...
								<a>...</a>
								<a href="${path}/auth/promotionNullServlet?currentPage=${lastPage}&searchTitle=${searchTitle}">end</a>		
							</div>
						<br class="clear" />
					</div>
					<br class="clear" />
